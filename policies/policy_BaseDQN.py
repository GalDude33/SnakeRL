...
from state_utils.State import SquareAroundHeadState, DiamondAroundHeadState, RadarState, \
    NO, FLIP, SPATIAL, FULL, NUM_PER_TYPE, augment_after_normaliztion
    ...
    def act(self, round, prev_state, prev_action, reward, new_state, too_slow):
        ...
        if prev_state is not None:
            ...
            if self.augment_after_normaliztion and prev_state[1][1] == new_state[1][1]:
                self.memory.record(*augment_after_normaliztion(prev_state_repr, prev_state[1][1], bp.Policy.ACTIONS.index(prev_action),
